...
After an admin has made a decision about my hat request, I will get a message in Rocket Chat from DiscoBot telling me if my hat request was approved or declined.

#### If I am an admin

All notifications for hat requests will be in the **#notify-hat-requests** channel in Rocket Chat. I will receive a message whenever:

* a user has made a hat request
* a hat request has been declined
* a hat request has been approved
